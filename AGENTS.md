...
**Last updated:** July 2026 (0.23.1 shipped)
...
| Definition migration rules (0.24.2+) | `palm/common/transforms/rules/` | `DefinitionMigrationRule` via transform registry; see [ADR-007](docs/adr/007-definition-revisioning.md) |
