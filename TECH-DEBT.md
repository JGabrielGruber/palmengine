...
| **0.51** | **Living Capabilities** — the profile's third axis comes alive; projections-as-capability | 🟢 planned · [VISION-0.51](docs/VISION-0.51.md) · [ADR-020](docs/adr/020-living-capabilities.md) | `composition.capabilities` (inert since 0.50.1) becomes authoritative — unifies scattered `enable_*` flags; culminates in a lean `ApplicationHost`, making the 0.50.5f fold-in *reachable* |
