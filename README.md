...
**Current release:** `0.19.0` — services are the API: `/v1/api/…` REST, per-domain MCP, definitions CRUD · Explorer workspace · [CHANGELOG.md](CHANGELOG.md) · [docs/MCP.md](docs/MCP.md) · [MIGRATION-0.16.md](MIGRATION-0.16.md) · [docs/VISION-0.16.md](docs/VISION-0.16.md)
