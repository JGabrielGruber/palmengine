...
**Current release:** `0.47.2` — Assist modularity + operator remote (menu/open) · Portal dogfood · WebSocket Assist · [CHANGELOG.md](CHANGELOG.md) · [RELEASE-0.34.5.md](RELEASE-0.34.5.md) · [VISION-0.34.md](docs/VISION-0.34.md) · [docs/MCP.md](docs/MCP.md)
