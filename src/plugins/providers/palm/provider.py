...
from plugins.providers.palm.bindings.resource.descriptor import describe, health
from plugins.providers.palm.bindings.resource.invoke import invoke_action
