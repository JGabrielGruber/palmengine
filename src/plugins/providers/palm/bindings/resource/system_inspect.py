...
from plugins.providers.palm.bindings.orchestration.payload import job_payload
from plugins.providers.palm.bindings.runtimes.wiring import get_bound_runtime
from plugins.providers.palm.exceptions import PalmLocalError, PalmRemoteError
...
def _remote_list(action: str, params: PalmInvokeParams) -> list[dict[str, Any]]:
    from plugins.providers.palm.flow.remote import client as remote_client
