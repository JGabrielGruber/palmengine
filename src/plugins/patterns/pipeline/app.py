...
from plugins.patterns.pipeline.bindings.mcp import register_pipeline_mcp_tools
...
class PipelineApp(PatternApp):
    ...
    def ready(self) -> None:
        ...
        from plugins.patterns.pipeline.bindings.design import register_pipeline_design_contributor
