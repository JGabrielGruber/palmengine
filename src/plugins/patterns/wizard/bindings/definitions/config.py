...
from plugins.patterns.wizard.bindings.definitions.kinds import PROTECTED_KINDS, WizardStepKind
...
class WizardStepConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if self.step_kind == "branch":
            from plugins.patterns.wizard.flow.branch.predicate import validate_when_clause
