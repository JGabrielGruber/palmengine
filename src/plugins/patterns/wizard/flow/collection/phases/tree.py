...
from plugins.patterns.wizard.flow.collection.state import collection_phase
...
from plugins.patterns.wizard.flow.collection.phases.fields import build_fields_phase
from plugins.patterns.wizard.flow.collection.phases.menu import build_menu_phase
from plugins.patterns.wizard.flow.collection.phases.remove import build_remove_phase
from plugins.patterns.wizard.flow.collection.phases.select import build_select_phase
