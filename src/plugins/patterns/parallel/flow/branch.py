...
from plugins.patterns.parallel.bindings.definitions.config import BranchConfig
from plugins.patterns.parallel.flow.merge import record_branch_result
from plugins.patterns.parallel.flow.scope import (
    enter_branch,
    leave_branch,
