...
from bundles.standard.runtimes.mcp.assist.shape.catalog import (
...
from bundles.standard.runtimes.mcp.assist.shape.design import (
    design_proposal_id_from_path,
    shape_design_publish_assistant,
)
from bundles.standard.runtimes.mcp.assist.shape.flow_create import shape_flow_create_assistant
from bundles.standard.runtimes.mcp.assist.shape.session import (
    assist_session_flat,
