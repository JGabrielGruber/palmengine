...
from bundles.standard.runtimes.mcp.agent_assets import read_skill_asset


def register_core_resources(mcp: Any, rest_client: Any, *, config: Any) -> None:
    from bundles.standard.runtimes.mcp.assist.dispatch import assist_routes_payload
    ...
    _register_skill_reference(
        "references/branching-flows",
        title="Palm agent skill — hub menus, route_on_answer, and loop-back wizards.",
    )
