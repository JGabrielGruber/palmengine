...
from bundles.standard.runtimes.server.surfaces.ssr.explorer.components import data_table
    ...
    def catalog(self, request: ServerRequest) -> ServerResponse:
        ...
        return html_response(
            explorer_page(
                ...
                subtitle="Installed behavior-tree patterns from plugins.patterns.",
            )
        )
