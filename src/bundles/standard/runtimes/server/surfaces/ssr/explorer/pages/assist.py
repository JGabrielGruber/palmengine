...
from bundles.standard.runtimes.server.surfaces.ssr.explorer.forms import assist_start_form
...
class AssistPages:
    ...
    def session(self, request: ServerRequest, *, instance_id: str) -> ServerResponse:
        ...
        from bundles.standard.runtimes.server.surfaces.ssr.explorer.pages.utils import query_message
