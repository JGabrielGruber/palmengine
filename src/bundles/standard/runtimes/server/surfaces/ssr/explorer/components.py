...
from plugins.kits.server.ssr.render import escape, pretty_json
...
def alert(message: str, *, tone: str = "success") -> str:
    from bundles.standard.runtimes.server.surfaces.ssr.explorer import forms
...
def wizard_prompt_card(
    ...
    *,
    ...
    from bundles.standard.runtimes.server.surfaces.ssr.explorer.forms import alert, wizard_input_form
...
def collection_item_card(
    ...
    *,
    ...
    from bundles.standard.runtimes.server.surfaces.ssr.explorer.forms import collection_action_form
...
def wizard_workspace(
    ...
    *,
    ...
    from bundles.standard.runtimes.server.surfaces.ssr.explorer.pages.utils import status_badge
