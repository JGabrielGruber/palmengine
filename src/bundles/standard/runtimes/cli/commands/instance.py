...
from bundles.standard.runtimes.cli.commands.views import render_instance_table
...
from bundles.standard.runtimes.cli.shared.output import emit_json, snapshots_to_json, summaries_payload
...
def cmd_instance_resume(ctx: CliContext, args: list[str]) -> int:
    from bundles.standard.runtimes.cli.commands.resume import cmd_resume
