...
from bundles.standard.app import DeploymentProfile, run_host
from bundles.standard.app.session import create_console
from bundles.standard.app.settings import PalmSettings
from bundles.standard.runtimes.cli.commands.registry import build_registry
from bundles.standard.runtimes.cli.shared.args import CliInvocation, build_parser, invocation_from_namespace
...
from bundles.standard.runtimes.cli.shared.version_info import print_version_brief, print_version_full
from bundles.standard.runtimes.cli.tui.repl import run_repl
...
def main(argv: list[str] | None = None) -> int:
    ...
    if inv.command == "host":
        from bundles.standard.runtimes.cli.shared.args import settings_from_invocation
