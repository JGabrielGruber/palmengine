"""Standalone CQRS wiring — buses without ApplicationHost projections.

Shared by lean ApplicationHost reads and host-less ServerContext. Lives in
common so the embedded host path does not import ``palm.kits.server``.
"""
