...
class DriveObservabilityHook(JobHookAdapter):
    ...
    schedulers. Pass to :meth:`~palm.common.runtimes.base.BaseRuntime.start` via
...
class AuthMiddleware(JobHookAdapter):
    ...
    :class:`~palm.common.runtimes.base.BaseRuntime`. Enable via ``auth_enforce=True``
    on :meth:`~palm.common.runtimes.base.BaseRuntime.start`.
    """
