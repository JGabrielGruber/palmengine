...
from palm.patterns.wizard.phases.collection.fields import build_fields_phase
from palm.patterns.wizard.phases.collection.menu import build_menu_phase
from palm.patterns.wizard.phases.collection.remove import build_remove_phase
from palm.patterns.wizard.phases.collection.select import build_select_phase
