...
- **0.47.9** — **Runtime-factory registry (3 `app→runtimes`) + remaining `common→services` (assist view, analytics preflight, `ServerContext`/PD-013)** — drive upward toward 0; flip the guard to fail on any new upward edge.
