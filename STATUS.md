...
**Last Updated:** September 19, 2026 · José closed **0.69** (2026-09-17). Floor: one embedded walk without Assist. ADR [037](docs/adr/037-navigator-invert.md) **Accepted**. Package stamp stays `0.68.0`. Assist stays until [surface deflation](docs/vision/VISION-SURFACE-DEFLATION.md). Queue seed: [authoring adapter](docs/vision/VISION-AUTHORING.md) (not an open minor).  
...
| **Later** | [SURFACE-DEFLATION](docs/vision/VISION-SURFACE-DEFLATION.md) · [SD-021](TECH-DEBT.md#sd-021) · [VISION-0.56](docs/vision/VISION-0.56.md) · [AUTHORING](docs/vision/VISION-AUTHORING.md) · [TINY-LLM](docs/vision/VISION-TINY-LLM.md) · [TUNNELS](docs/vision/VISION-TUNNELS.md) → [Grove](docs/vision/VISION-GROVE.md) |
...
| Authoring adapter (needs) | [VISION-AUTHORING](docs/vision/VISION-AUTHORING.md) — land a shape on embedded `definitions`; after Navigator consume |
