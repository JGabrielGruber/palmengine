...
**Next:** 0.20.4 — `palm_assist` `format=assistant` default per [assistant-powertool-views spec](docs/superpowers/specs/2026-07-01-assistant-powertool-views-design.md).
