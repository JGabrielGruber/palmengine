...
**Last Updated:** September 15, 2026 · Tiny LLM queue seed named (not a 0.68 unit). Portal two-slot + pt-BR empty FAB remains a side cut. Package stays `0.67.0` until 0.68 exit.  
